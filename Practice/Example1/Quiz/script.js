...
let quest1 = {question: 'What is the capital of Thailand?'          ,answers: ['Khon kaen', 'Chiang Mai', 'Bangkok', 'Pattaya'],correctAnswer: 3};
let quest2 = {question: `What is the result of '1' - 1 ?`           ,answers: [0, 'NaN', '11', 'error']                        ,correctAnswer: 1};
let quest3 = {question: `Where do we live in ?`                     ,answers: ['Venus', 'Pluto', 'Earth', 'Mercury']           ,correctAnswer: 3};
let quest4 = {question: `What is a primitive number data type?`     ,answers: ['1', 1, `1`, '1']                               ,correctAnswer: 2};
let quest5 = {question: `what is the biggest star in the Milky way?`,answers: ['Jupiter', 'Earth', 'Sun', 'Cow Milk!!!']       ,correctAnswer: 3};
